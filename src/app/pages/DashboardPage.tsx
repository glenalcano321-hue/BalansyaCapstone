...
const utilizationData = [
  { name: 'Worker 1', station: 'ST-01', utilization: 85, idle: 15 },
  { name: 'Worker 2', station: 'ST-02', utilization: 92, idle: 8 },
  { name: 'Worker 3', station: 'ST-03', utilization: 78, idle: 22 },
  { name: 'Worker 4', station: 'ST-04', utilization: 88, idle: 12 },
];

const alerts = [
  { type: 'critical', message: 'Station ST-04 operating at 105% capacity - immediate rebalancing required' },
  { type: 'warning', message: 'Worker Worker 3 showing 22% idle time - consider task redistribution' },
